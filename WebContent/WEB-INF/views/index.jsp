...
<!doctype html>
  ...
  <body>
    ...
    <script type="text/javascript">
	    ...
	    var datas = new Array();
    	if (case_place != "全部"){
          	datas = [{name: case_place ,value: 1 }];
    	}
      	
        // legend内容
        var legendData=[''];
        // legend自定义颜色 不设置有默认色
        var legendColor=['blue'];
        // 映射颜色  不设置有默认色
        var visColor=["#e8192f","#d6664d","#B9044E","#f0ba2e","#d3ce2b","#169A7f","#0b6573","#1BB3c8"];
